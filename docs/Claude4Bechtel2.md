# Using Claude Code: A Small Starter Guide

*IIT Delhi x Bechtel AI/ML Programme · July 2026*
...
Create a folder in your working folding (say `my-agent-try-1`). Inside that create a `.claude` folder, and further sub-folders:
...
| `site-safety-summary` | Summarizes an incident report into the standard Bechtel format |
...
**"Summarize the last 5 emails about the concrete pour schedule"**
...
**With context:**
> "This is a 40-page subcontractor programme submitted for the civil works package on the Noida Airport project. Summarize it in bullet points. Focus on milestone dates, any float mentioned, and any risks to the concrete works. Keep it under 10 bullets."
